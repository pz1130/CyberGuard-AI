...
const PRESETS: Preset[] = [
  ...
  { name: 'MiniMax 国内版', provider_type: 'openai', base_url: 'https://api.minimax.cn/v1', default_models: ['MiniMax-M3', 'MiniMax-M2.7', 'MiniMax-M2.5'], key_placeholder: 'MiniMax API Key', color: '#ff6b35' },
  { name: 'MiniMax 海外版', provider_type: 'openai', base_url: 'https://api.minimax.io/v1', default_models: ['MiniMax-M3', 'MiniMax-M2.7', 'MiniMax-M2.5'], key_placeholder: 'MiniMax API Key', color: '#ff8a4c' },
